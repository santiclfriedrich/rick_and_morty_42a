...
describe("Test de Rutas", ()=>{
    ...
    describe('GET /rickandmorty/login', () => {
        it('Informacion sea correcta y nos de acceso', async() => {
            ...
            const {body} = await agent.get( "/rickandmorty/login?email=santi@gmail.com&password=santi123");
        ...
        it('Informacion sea incorrecta y nos bloquea', async() => {
            ...
            const {body} = await agent.get( "/rickandmorty/login?email=santi@gmail.com&password=cualquiera");
    ...
    describe("POST /rickandmorty/fav", () => {
        ...
        const char1 = {id:1, name:"Santi"}
        const char2 = {id:2, name:"Jorge"}
    ...
    describe("DELETE /rickandmorty/fav/:id", () => {
        ...
        it("Si no se envia un ID correcto se devuelve el mismo array", async () => {
            ...
            const {body} = await agent.delete("/rickandmorty/fav/21102")
